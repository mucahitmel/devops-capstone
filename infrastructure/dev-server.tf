...
resource "aws_launch_template" "PetclinicServerLT-muco" {
  image_id = var.ami
...
resource "aws_instance" "PetclinicServer-muco" {
  launch_template {
    id = aws_launch_template.PetclinicServerLT-muco.id
    version = aws_launch_template.PetclinicServerLT-muco.latest_version
  }
  tags = {
